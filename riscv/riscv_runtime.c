                                             ...
                                             u8 **branch_source)
{
  ...
  translation_ptr = ptr;
  riscv_emit_bne(riscv_reg_t0, riscv_reg_zero, 8);
  ptr = translation_ptr;
...
static void riscv_emit_arm_cpsr_store_nzc_preserve_v(u8 **ptr_ref)
{
  u8 *ptr = *ptr_ref;
  u8 *translation_ptr;
...
static void riscv_emit_arm_cpsr_store_nz_preserve_cv(u8 **ptr_ref)
{
  u8 *ptr = *ptr_ref;
  u8 *translation_ptr;
...
static void riscv_emit_arm_cpsr_store_selected_nzcv(u8 **ptr_ref,
                                                    u32 flag_mask)
{
  u32 clear_mask = 0;
  u8 *ptr;
  ...
  if (flag_mask == 0x0fu)
  {
    riscv_emit_arm_cpsr_store_nzcv(ptr_ref);
    return;
  }

  if (flag_mask == 0x0eu)
  {
    riscv_emit_arm_cpsr_store_nzc_preserve_v(ptr_ref);
    return;
  }

  if (flag_mask == 0x0cu)
  {
    riscv_emit_arm_cpsr_store_nz_preserve_cv(ptr_ref);
    return;
  }
                                    ...
                                    u32 cycles)
{
  ...
  riscv_emit_arm_reg_store(&ptr, rd, riscv_reg_t2);
  if (set_flags)
    riscv_emit_arm_cpsr_store_nz_preserve_cv(&ptr);
  riscv_emit_adjust_cycles(&ptr, cycles);
                                                  ...
                                                  u32 flag_status)
{
  ...
  if (hi == 0x40u && alu_op == 2u)
  {
    ...
    if (need_c)
    {
      ...
      riscv_emit_srl(riscv_reg_t4, riscv_reg_t0, riscv_reg_t4);
      riscv_emit_andi(riscv_reg_t4, riscv_reg_t4, 1);
      riscv_emit_sltiu(riscv_reg_t5, riscv_reg_t1, 33);
      riscv_emit_sltiu(riscv_reg_t6, riscv_reg_t1, 1);
      riscv_emit_xori(riscv_reg_t6, riscv_reg_t6, 1);
      riscv_emit_and(riscv_reg_t5, riscv_reg_t5, riscv_reg_t6);
      riscv_emit_sub(riscv_reg_t5, riscv_reg_zero, riscv_reg_t5);
      riscv_emit_and(riscv_reg_t4, riscv_reg_t4, riscv_reg_t5);
      riscv_emit_sltiu(riscv_reg_t5, riscv_reg_t1, 1);
      riscv_emit_sub(riscv_reg_t5, riscv_reg_zero, riscv_reg_t5);
      riscv_emit_and(riscv_reg_t3, riscv_reg_t3, riscv_reg_t5);
  ...
  else if (hi == 0x40u)
  {
    ...
    if (need_c)
    {
      riscv_emit_addi(riscv_reg_t4, riscv_reg_t1, -1);
      riscv_emit_srl(riscv_reg_t4, riscv_reg_t0, riscv_reg_t4);
      riscv_emit_andi(riscv_reg_t4, riscv_reg_t4, 1);
      riscv_emit_sltiu(riscv_reg_t5, riscv_reg_t1, 33);
      riscv_emit_sltiu(riscv_reg_t6, riscv_reg_t1, 1);
  ...
  else if (alu_op == 0u)
  {
    riscv_emit_sltiu(riscv_reg_t4, riscv_reg_t1, 32);
    riscv_emit_sub(riscv_reg_t4, riscv_reg_zero, riscv_reg_t4);
    riscv_emit_and(riscv_reg_t5, riscv_reg_t1, riscv_reg_t4);
    riscv_emit_xori(riscv_reg_t4, riscv_reg_t4, -1);
    riscv_emit_addi(riscv_reg_t6, riscv_reg_zero, 31);
    riscv_emit_and(riscv_reg_t6, riscv_reg_t6, riscv_reg_t4);
    riscv_emit_or(riscv_reg_t4, riscv_reg_t5, riscv_reg_t6);
    ...
    if (need_c)
    {
      ...
      riscv_emit_srl(riscv_reg_t4, riscv_reg_t0, riscv_reg_t4);
      riscv_emit_andi(riscv_reg_t4, riscv_reg_t4, 1);
      riscv_emit_sltiu(riscv_reg_t5, riscv_reg_t1, 32);
      riscv_emit_sltiu(riscv_reg_t6, riscv_reg_t1, 1);
      riscv_emit_xori(riscv_reg_t6, riscv_reg_t6, 1);
      riscv_emit_and(riscv_reg_t5, riscv_reg_t5, riscv_reg_t6);
      riscv_emit_sub(riscv_reg_t5, riscv_reg_zero, riscv_reg_t5);
      riscv_emit_and(riscv_reg_t4, riscv_reg_t4, riscv_reg_t5);
      riscv_emit_srli(riscv_reg_t5, riscv_reg_t0, 31);
      riscv_emit_sltiu(riscv_reg_t6, riscv_reg_t1, 32);
      riscv_emit_xori(riscv_reg_t6, riscv_reg_t6, 1);
      riscv_emit_sub(riscv_reg_t6, riscv_reg_zero, riscv_reg_t6);
      riscv_emit_and(riscv_reg_t5, riscv_reg_t5, riscv_reg_t6);
      riscv_emit_or(riscv_reg_t4, riscv_reg_t4, riscv_reg_t5);
      riscv_emit_sltiu(riscv_reg_t5, riscv_reg_t1, 1);
      riscv_emit_sub(riscv_reg_t5, riscv_reg_zero, riscv_reg_t5);
                                                ...
                                                bool exits)
{
  ...
  else if (hi >= 0xa0u && hi <= 0xafu)
  {
    if (hi < 0xa8u)
    {
      riscv_emit_li(&ptr, riscv_reg_t2, (pc & ~2u) + 4u + (imm * 4u));
    }
    else
    {
      translation_ptr = ptr;
                                    ...
                                    u32 flag_status)
{
  ...
  riscv_emit_arm_reg_or_pc_load(&ptr, riscv_reg_t0, hrd, pc + 4u);
  riscv_emit_arm_reg_or_pc_load(&ptr, riscv_reg_t1, hrs, pc + 4u);
                                ...
                                u32 cycles)
{
  ...
  riscv_emit_arm_reg_or_pc_load(&ptr, riscv_reg_t0, hrs, pc + 4u);
  translation_ptr = ptr;
  riscv_emit_andi(riscv_reg_t1, riscv_reg_t0, -2);
  ptr = translation_ptr;
  riscv_emit_arm_reg_store(&ptr, REG_PC, riscv_reg_t1);
                                           ...
                                           u32 cycles)
{
  ...
  riscv_emit_li(&ptr, riscv_reg_a0, pc);
                                         ...
                                         bool *cycles_emitted)
{
  ...
  if (riscv_emit_native_thumb_simple_data(&ptr, opcode, pc, cycles, exits))
  {
    *translation_ptr_ref = ptr;
                                     ...
                                     u32 cycles)
{
  ...
  riscv_emit_li(&ptr, riscv_reg_t0, link_value);
  riscv_emit_arm_reg_store(&ptr, REG_LR, riscv_reg_t0);
  riscv_emit_li(&ptr, riscv_reg_t0, target_pc);
  riscv_emit_arm_reg_store(&ptr, REG_PC, riscv_reg_t0);
  riscv_emit_adjust_cycles(&ptr, cycles);
