...
BEGIN {
	...
	track("thumb_reg_shift_code_bytes", 784, "thumb_direct");
	...
	track("carry_flag_sbcs_code_bytes", 176, "arm_flags_shift");
	track("carry_flag_rscs_code_bytes", 172, "arm_flags_shift");
	track("logical_flag_code_bytes", 456, "arm_flags_shift");
	track("data_ext_code_bytes", 244, "arm_flags_shift");
	track("reg_shift_data_code_bytes", 216, "arm_flags_shift");
	track("reg_shift_flag_lsl_code_bytes", 184, "arm_flags_shift");
	track("reg_shift_flag_lsr_code_bytes", 184, "arm_flags_shift");
	track("reg_shift_flag_asr_code_bytes", 200, "arm_flags_shift");
	...
	track("shifted_reg_offset_code_bytes", 132, "arm_half_signed_memory");
	track("shifted_reg_offset_store_code_bytes", 92, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_store_code_bytes", 96, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_lsr_code_bytes", 92, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_lsr_store_code_bytes", 96, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_asr_code_bytes", 92, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_asr_store_code_bytes", 96, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_ror_code_bytes", 96, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_ror_store_code_bytes", 104, "arm_half_signed_memory");
