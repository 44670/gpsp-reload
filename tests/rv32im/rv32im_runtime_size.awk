...
BEGIN {
	...
	track("thumb_hi_add_mov_code_bytes", 76, "thumb_direct");
	...
	track("pc_source_code_bytes", 312, "arm_control_flow");
	...
	track("load_pc_code_bytes", 64, "arm_word_memory");
	track("load_byte_pc_code_bytes", 64, "arm_word_memory");
	track("pc_base_load_code_bytes", 104, "arm_word_memory");
	track("pc_base_store_code_bytes", 80, "arm_word_memory");
	...
	track("reg_offset_pc_byte_store_code_bytes", 88, "arm_word_memory");
	track("reg_offset_store_code_bytes", 84, "arm_word_memory");
	track("shifted_reg_offset_pc_lsl_word_code_bytes", 84, "arm_word_memory");
	track("shifted_reg_offset_pc_lsl_word_store_code_bytes", 88, "arm_word_memory");
	track("shifted_reg_offset_pc_lsr_word_code_bytes", 84, "arm_word_memory");
	track("shifted_reg_offset_pc_lsr_word_store_code_bytes", 88, "arm_word_memory");
	track("shifted_reg_offset_pc_asr_word_code_bytes", 84, "arm_word_memory");
	track("shifted_reg_offset_pc_asr_word_store_code_bytes", 88, "arm_word_memory");
	track("shifted_reg_offset_pc_ror_word_code_bytes", 80, "arm_word_memory");
	track("shifted_reg_offset_pc_ror_word_store_code_bytes", 88, "arm_word_memory");

	track("half_load_pc_code_bytes", 64, "arm_half_signed_memory");
	track("half_reg_load_pc_code_bytes", 68, "arm_half_signed_memory");
	track("signed_byte_reg_load_pc_code_bytes", 72, "arm_half_signed_memory");
	track("signed_half_reg_load_pc_code_bytes", 72, "arm_half_signed_memory");
	track("signed_byte_load_pc_code_bytes", 68, "arm_half_signed_memory");
	track("signed_half_load_pc_code_bytes", 68, "arm_half_signed_memory");
	track("pc_base_half_load_code_bytes", 136, "arm_half_signed_memory");
	...
	track("half_load_code_bytes", 140, "arm_half_signed_memory");
	track("half_store_code_bytes", 84, "arm_half_signed_memory");
	track("half_reg_load_code_bytes", 152, "arm_half_signed_memory");
	track("half_reg_pc_load_code_bytes", 164, "arm_half_signed_memory");
	...
	track("half_writeback_load_code_bytes", 88, "arm_half_signed_memory");
	track("reg_offset_rrx_load_code_bytes", 104, "arm_half_signed_memory");
	track("reg_offset_rrx_store_code_bytes", 108, "arm_half_signed_memory");
	track("shifted_reg_offset_code_bytes", 120, "arm_half_signed_memory");
	track("shifted_reg_offset_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_lsr_code_bytes", 84, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_lsr_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_asr_code_bytes", 84, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_asr_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_ror_code_bytes", 80, "arm_half_signed_memory");
	track("shifted_reg_offset_pc_ror_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_lsr_code_bytes", 80, "arm_half_signed_memory");
	track("shifted_reg_offset_asr_code_bytes", 84, "arm_half_signed_memory");
	track("shifted_reg_offset_ror_code_bytes", 92, "arm_half_signed_memory");
	track("shifted_reg_offset_lsr_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_asr_store_code_bytes", 88, "arm_half_signed_memory");
	track("shifted_reg_offset_ror_store_code_bytes", 96, "arm_half_signed_memory");
	track("writeback_store_code_bytes", 84, "arm_half_signed_memory");
	track("writeback_load_code_bytes", 76, "arm_half_signed_memory");
	track("reg_offset_writeback_store_code_bytes", 88, "arm_half_signed_memory");
	track("reg_offset_writeback_load_code_bytes", 84, "arm_half_signed_memory");
