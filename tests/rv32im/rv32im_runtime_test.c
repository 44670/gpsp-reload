...
static void expect_signed_halfword_load_pc_unsupported_rejected(u8 *code)
{
...
void _start(void)
{
  ...
  expect_signed_halfword_load_pc_unsupported_rejected(
    code + REG_OFFSET_REJECT_BLOCK_OFFSET);
