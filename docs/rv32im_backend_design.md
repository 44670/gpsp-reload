...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  shifted `EOR`/`ADD`/`ORR`/`MOV`, `MRS CPSR`,
  ...
  fifty-seven runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical CPSR flag results and
  ...
  extended shifted data-processing results checked,
