...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  one hundred eight runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical/test-op CPSR flag results and
  ...
  MSR CPSR control mode/banked-LR effects and remaining-cycle handoff, SPSR helper-write effects, and native PSR
  accounting checked,
