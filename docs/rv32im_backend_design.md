...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  one hundred eleven runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical/test-op CPSR flag results and
  ...
  transfers, block-memory LDM and SMC/IRQ remaining-cycle handoffs, and
