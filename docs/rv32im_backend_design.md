...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  ninety-eight runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical/test-op CPSR flag results and
  ...
  immediate and PC-relative halfword remaining-cycle handoffs, register-offset, and writeback halfword
  ...
  unsupported-block, Thumb lookup-miss, helper load, load-to-PC, PC-relative load, immediate and PC-relative halfword load, direct-branch, BL, BX ARM, BX Thumb, SWI, and PC-write ADD
