...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  ninety-three runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical/test-op CPSR flag results and
  ...
  unsupported-block, Thumb lookup-miss, direct-branch, BL, BX ARM, BX Thumb, SWI, and PC-write ADD
