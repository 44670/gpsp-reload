...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  fifty-six runtime blocks executed, ADDS/SUBS/RSBS/CMP/logical CPSR flag results and
  ...
  checked, carry-input data-processing, carry-input flag, and logical flag
  results checked,
