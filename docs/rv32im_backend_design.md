...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  forty-six runtime blocks executed, ADDS/CMP CPSR flag results and
  ...
  multiply/accumulate, unsigned/signed long multiply, and long multiply flag
  results checked, helper memory and alert observations hashed,
