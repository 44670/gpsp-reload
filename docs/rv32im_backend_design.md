...
- data-processing, flag-producing data-processing, multiply, long multiply,
  ...
  register-offset load/store, PC-register-offset word/byte load/store, shifted-LSL/LSR/ASR
...
- qemu-user harness `compare` execution of generated RV32IM
  ...
  register-offset/shifted-LSL/shifted-LSL-with-PC/shifted-LSR/shifted-LSR-with-PC/shifted-ASR/shifted-ASR-with-PC/shifted-ROR/RRX load ops,
  ...
  remaining-cycle handoffs, shifted-LSL/shifted-LSR/shifted-ASR PC-register-offset stores,
  ...
  two hundred twenty two runtime blocks executed, sixty three total runtime
  fallbacks split into four initial lookup fallbacks, fifty seven relookup
  ...
  register-offset byte-store, shifted-LSL/shifted-LSL-with-PC/shifted-LSR/shifted-LSR-with-PC/shifted-ASR/shifted-ASR-with-PC/shifted-ROR register-offset byte-store, and RRX
  ...
  shifted-LSR, and shifted-ASR with `Rm == PC` load/store, ordinary shifted-LSR,
...
word/byte store, shifted-LSL/LSR/ASR PC-register-offset byte load/store, and halfword
